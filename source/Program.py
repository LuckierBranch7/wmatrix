...
def main(stdscr, args):
    ...
    try:
        ...
        print("Error: Couldn't get terminal size. Try running in a different terminal.")
        return
    ...
    while True:
        ...
        for i in range(width):
            ...
            if drops[i] > 0:
                ...
                if drops[i] <= height:
                    stdscr.addstr(drops[i]-1, i, chars[i], curses.color_pair(2) | curses.A_BOLD)
                ...
                for j in range(1, min(drops[i], height)):
                    if drops[i] - j < height:
                        ...
                        stdscr.addstr(drops[i]-j-1, i, char, curses.color_pair(1) | brightness)
